...
<body>
    ...
    <div class="main-wrapper">
        ...
        <?php include "userlist_order/view/list_order_Form.php"; ?>


        <?php include "userlist_order/view/modal.php"; ?>
        <!---End Main --->
    ...
    <script src="userlist_order/javascript/function.js"></script>


    <script src="assets/plugins/alertify/alertify.min.js"></script>


    <script src="userlist_order/javascript/realtime_fetch_order.js"></script>

    <script src="userlist_order/javascript/headerOrderStatus.js"></script>
