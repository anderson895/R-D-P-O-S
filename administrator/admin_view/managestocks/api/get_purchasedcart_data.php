    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<td class="text-start">' . $NetProfit . '</td>';
        echo '<td hidden>' . $row['prod_id'] . '</td>';
        echo '<td hidden>' .$row['purchased_Tax']. '</td>';
        echo '<td>
        <a class="ToglerRemoveCart" data-prodcart="'.$row['purchase_id'].'"><img src="assets/img/icons/delete.svg" alt="svg"></a>
    ...
    if($Grandtotal_cost ){
        ...
        echo '<div class="row">';
        echo '<div class="col-lg-12 float-md-right">';
        ...
        echo '<li>';
        echo '<h4>Order Tax</h4>';
        echo '<h5>₱ '.number_format($Grandtotal_taxAmount,2).'</h5>';
        echo '</li>';


        echo '<li>';
        echo '<h4>Discount</h4>';
        echo '<h5>₱ '.number_format($Grandtotal_Discount,2).'</h5>';
        echo '</li>';
        echo '<li class="total">';
        echo '<h4>Grand Total</h4>';
        echo '<h5>₱ '. number_format($Grandtotal_cost,2) . '</h5>';
        echo '</li>';
        echo '</ul>';
        echo '</div>';
        echo '</div>';
