$(document).ready(function() {
    ...
    if ($('.datanew').length > 0) {
        ...
        // Function to get the 'type' parameter from the URL
        ...
        var defaultSearchValue = getUrlParameter('type');
        ...
        $('.datanew').DataTable({
            ...
            "search": {
                "search": defaultSearchValue // Use the extracted 'type' as default search value
            },
