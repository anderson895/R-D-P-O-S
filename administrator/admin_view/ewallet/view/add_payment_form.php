<div class="page-wrapper">
    ...
    function validateForm() {
        ...
        if (!profilePicture) {
            alertify.error("Please upload a profile picture");
            return false;
        }
    ...
    document.getElementById("submitBtn").addEventListener("click", function(event) {
        ...
        if (validateForm()) {
            ...
            $.ajax({
                url: "ewallet/controller/addPaymentProcess.php", // Replace with the actual PHP script URL
                method: "POST",
                data: formData,
                processData: false,
                contentType: false,
