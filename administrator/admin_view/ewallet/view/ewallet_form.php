...
<div class="page-btn">
<a class="btn btn-added"  href='addnewpayment.php'><img src="assets/img/icons/plus.svg" alt="img" class="me-1">Add New payment</a>
</div>
</div>
...
SELECT * FROM mode_of_payment WHERE (payment_status = '0' OR payment_status = '1') AND payment_type = 'ewallet';
");
...
<td class="text-end">
<a class="me-3" href="edit_payment.php?payment_id=<?=$payment_id?>">
