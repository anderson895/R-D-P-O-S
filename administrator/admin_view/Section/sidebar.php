            ...
            <ul>
                ...
                <li>
                    <a href="../new-orders-view/orders.php">
                        ...
                        <span class="badge bg-danger text-white" id="pendingCount">0</span>
                    </a>
                </li>
                ...
                ?>
                    ...
                    <li>
                        <a href="backup.php"><img src="assets/img/database.png" alt="img"><span class="text-white"> Backup</span> </a>
                    </li>
