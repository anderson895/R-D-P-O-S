...
<div class="header">
    ...
    <?php include "manageunit/view/manageunit_form.php"; ?>
    <?php include "manageunit/view/modal.php"; ?>
...
<script src="manageunit/javascript/LenFunction.js"></script>
<script src="manageunit/javascript/toglerAddUnit.js"></script>
<script src="manageunit/javascript/toglerEditUnit.js"></script>
<script src="manageunit/javascript/deleteunit.js"></script>
<script src="manageunit/controller/ajaxCheckStatus.js"></script>
<script src="manageunit/javascript/insert_unitModalValidation.js"></script>
</body>
</html>
