                    ...
                    <tbody class="table-body">
                        ...
                        while ($rate = $getRates->fetch_assoc()) {
                            ...
                            if ($r_status = $rate['r_status'] == '1') {
                                $button_for_approval = '<button type="button" class="btn btn-secondary btn-block btnRequestToRestrict" data-allowedid="' . $rate['r_rate_id'] . '"><i class="fas fa-times"></i></button>';
