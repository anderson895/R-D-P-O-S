...
$(".deleteConfirmation").on("click", function() {
    discount_id = $(this).attr('data-voucher_id');
    acc_id = $(this).attr('data-acc_id');
    discount_status = $(this).attr('data-voucher_status');
    //$('#ssid').val(ssid);
    ...
    Swal.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
                url: 'managediscountORDER/controller/deleteDiscount.php', // Palitan mo ito ng tamang URL
                type: 'POST',
                data: {
