...
<div class="whirly-loader"> </div>
            ...
            <div class="content">
                <div class="page-header">
                    <div class="page-title">
                        <?php include "stock_in/view/add_stocks.php"; ?>
    ...
    <script src="stock_in/controller/SearchAjax.js"></script>
    <script src="stock_in/javascript/editTogler.js"></script>
    <script src="stock_in/controller/EditSearchAjax.js"></script>
    <script src="stock_in/controller/removeAjax.js"></script>
