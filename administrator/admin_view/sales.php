...
<body>
    ...
    <div class="main-wrapper">
        ...
        if (isset($_GET['sales_type'])) {
            if ($_GET['sales_type'] == 'POS') {
                include "sales/sales-pos.php";
            } elseif ($_GET['sales_type'] == 'Ordering') {
                include "sales/sales-orders.php";
            } else {
        ?>
                <script>
                    window.location.href = 'sales.php?sales_type=POS'
                </script>
            <?php
            }
        } else {
