...
$(document).ready(function () {
    $(".RemoveToDisplayPayment").on("click", function () {
        ...
        var message = "Remove this Bank details and its automatically disable";
        ...
        Swal.fire({
          ...
          if (result.value) {
            ...
            $.ajax({
              url: 'banklist/controller/RemoveToDisplayBank.php',
              type: 'POST',
              data: {
                acc_id: acc_id,
                payment_status:2,
              ...
              error: function (xhr, status, error) {
                ...
                Swal.fire({
                  type: "error",
                  title: "Error",
                  text: "An error occurred while enabling/disabling the e bank.",
    ...
    $(".check").on("change", function () {
      ...
      if (checkbox.is(":checked")) {
        ...
        var message = "Are you sure you want to enable this bank?";
      } else {
        // Checkbox is unchecked, show "Disable" message
        var message = "Are you sure you want to disable this bank ?";
      }
      ...
      Swal.fire({
        ...
        if (result.value) {
          // If the user clicks "Yes," proceed with the AJAX request
          $.ajax({
            url: 'banklist/controller/changeBankStatus.php',
            type: 'POST',
            data: {
              acc_id: acc_id,
              payment_id: payment_id,
            ...
            success: function (response) {
              ...
              Swal.fire({
                type: "success",
                title: "Action Successful",
                text: "Bank has been " + (checkbox.is(":checked") ? "enabled" : "disabled") + ".",
                confirmButtonClass: "btn btn-success"
              });
            ...
            error: function (xhr, status, error) {
              ...
              Swal.fire({
                type: "error",
                title: "Error",
                text: "An error occurred while enabling/disabling the Bank.",
                confirmButtonClass: "btn btn-danger"
              });
            }
          });
