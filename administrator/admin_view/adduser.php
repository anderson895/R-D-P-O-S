...
<div class="header">
    ...
    <?php  include "adduser/view/adduser_form.php"; ?>
</div>
</div>
</div>
...
<script src="adduser/controller/addUserProcessAjax.js"></script>
<script src="adduser/javascript/address_api.js"></script>
</body>
</html>