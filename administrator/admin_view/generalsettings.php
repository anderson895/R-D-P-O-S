...
<div class="header">
    ...
    <?php  include "generalSettings/view/generalSetting_form.php"; ?>


<script src='generalSettings/controller/profileValidation.js'></script>
<script src='generalSettings/javascript/email_validation.js'></script>
<script src='generalSettings/javascript/registerLen_validation.js'></script>
