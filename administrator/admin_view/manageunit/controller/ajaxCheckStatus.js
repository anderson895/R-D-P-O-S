...
$(document).ready(function () {
    ...
    $(".check").on("change", function () {
      ...
      if (checkbox.is(":checked")) {
        ...
        var message = "Are you sure you want to enable this unit?";
      } else {
        // Checkbox is unchecked, show "Disable" message
        var message = "Are you sure you want to disable this unit?";
      }

      // Traverse the DOM to find the associated acc_id
      var unit_id = checkbox.val();
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          $.ajax({
            url: 'manageunit/controller/update_UnitStatusSingle.php',
            type: 'POST',
            data: {
              acc_id: acc_id,
              unit_id: unit_id,
              unit_status: checkbox.is(":checked") ? 1 : 0
            },
            success: function (response) {
              ...
              Swal.fire({
                ...
                text: "Unit has been " + (checkbox.is(":checked") ? "enabled" : "disabled") + ".",
