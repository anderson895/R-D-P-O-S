    ...
    <div class="row mt-5">
        ...
        <div class="col-12 mt-3">
            <div class="border rounded p-3">
               ...
               <p><span style="color: red; font-weight: bold;">●</span> <strong>Expired (Red):</strong> The item has already expired and is automatically excluded from the stock count.</p>
