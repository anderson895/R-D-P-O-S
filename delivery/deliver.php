...
<div class="container-fluid">
        ...
        <div class="col-15">
            <div class="container-fluid d-flex justify-content-center mb-2">
                <div class="card w-100">
                    <div class="card-body">
                      <center><h5 class="card-title" style="text-align: center;"><h1>LIST OF ORDERS</h1></center>
                        <div class="container">
    ...
    <div class="container">
                                    ...
                                    <div class="container">
                                    <button type="button" class="btn btn-danger tugleInvalid"  data-bs-toggle="modal" data-bs-target="#ModalInvalid" 
                                       data-transaction="<?=$order_transaction_code?>"
                                        data-productId="<?=$orders_prod_id?>"
                                        data-orders_qty="<?=$orders_qty?>"
                                        >
                                    ...
                                    <?php if($orders_status=="Delivered"){ ?> 
                                      ...
                                      .btn-gold {
                                        ...
                                        <button type="button" class="btn btn-gold  tugleArchive"  data-bs-toggle="modal" data-bs-target="#exampleModal4" 
                                        data-transaction="<?=$order_transaction_code?>"
                                        >
                                            Complete
                                        </button>
                                                ...
                                                <div class="modal-body">
                                                  <div class="container">
                                                    <div class="container mb-3" style="text-align: center;">
                                                        ORDER MARK AS <br> <b style='color:red;'>NOT DELIVERED</b>
                                                    </div>
                                                    
                                                    <form action="proceedDeliver.php" method="POST">
                                                    <input type="text" id="transactionInvalid" hidden  name="transactionId">
                                                    ...
                                                    <div class="container d-flex justify-content-center">
                                                        <div class="row">
                                                            ...
                                                            <div class="col">
                                                                <div class="container">
                                                                    <button type="submit" name="btnInvalid" class="btn btn-success">YES</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                              ...
                                              <div class="modal-content">
                                                <div class="modal-body">
                                                  <div class="container">
                                                    ...
                                                    <form action="proceedDeliver.php" method="POST">
                                                    <input type="hidden" id="transactionDeliver"  name="transactionId">
                                                    <input type="hidden" id="productIds"   name="productId">
                                                    <input type="hidden" id="qtys"   name="qty">
                                              ...
                                              <div class="modal-content">
                                                <div class="modal-body">
                                                  <div class="container">
                                                    <div class="container mb-3" style="text-align: center;">
                                                          ARE YOU SURE <br>
                                                        THE ORDER WAS <b style='color:green;'> DELIVERED</b> ?
                                                    </div>
                                              ...
                                              <div class="modal-dialog">
                                                <div class="modal-content">
                                                  <div class="modal-body">
                                                    <div class="container">
                                                    <form action="proceedDeliver.php" method="POST">
                                                    <input type="hidden" id="transactionCancel" name="transactionId">
                                                      <div class="container mb-3" style="text-align: center;">
                                                          ARE YOU SURE YOU<br>
                                                          WANT TO CANCEL<br>
                                                          ORDERS
...
<script>
      $('.tugleInvalid').click(function(){
              var transaction = $(this).attr('data-transaction')
              var productId = $(this).attr('data-productId')
              var qty=$(this).attr('data-orders_qty')
              $('#transactionInvalid').val(transaction)
