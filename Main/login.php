    ...
    <div class="account-content container">
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-md-6 d-none d-md-block">
                <img src="../upload_system/<?=$db_system_banner?>" alt="Banner" class="img-fluid rounded shadow">
            </div>

            <!-- Login Form -->
            <div class="col-md-5">
                <div class="login-content p-4 shadow-lg" style="background-color: white; border-radius: 15px;">
