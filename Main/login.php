    ...
    <div class="account-content">
        <div class="login-wrapper d-flex align-items-center justify-content-center">
            <div class="login-content">
                <div class="container shadow-lg p-4" style="background-color: white; border-radius: 15px; max-width: 400px;">
            ...
            <!-- Optional: Login Image Section (if needed) -->
            <div class="login-img d-none d-md-block ms-4">
                <img src="../upload_system/<?=$db_system_banner?>" alt="Banner" class="img-fluid rounded">
            </div>
        </div>
    </div>
</div>
