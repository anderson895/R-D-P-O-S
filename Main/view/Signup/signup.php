            ...
            <div class="login-content">
                <div class="login-userset">
                    <form method="POST">
                        ...
                        <div class="form-floating mb-3">
                            <input type="date" class="form-control" name="bday" id="birthdate" value="2006-01-01" required>
                        ...
                        <div class="form-floating mb-3">
                            <input type="number" class="form-control" name="contact" id="contact" required value="">
                            <label for="contact">Contact Number</label>
                            <div style="color:red;" id="contactError"></div>
                        </div>

                        <div class="form-floating mb-3">
                            <input type="password" class="form-control" name="pass" id="password" required value="">
                            <label for="password">Password</label>
                        </div>

                        <div class="form-floating mb-3">
                            <input type="password" class="form-control" name="cpass" id="confirmPassword" required value="">
                        ...
                        <div class="form-check mb-3" style="display: flex; align-items: center;">
                            <input type="checkbox" class="form-check-input" id="agreeTermsCheckbox" style="width: 16px; height: 16px; margin-right: 5px;" required>
