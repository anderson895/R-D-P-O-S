...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 29, 2024 at 06:11 PM
...
(19, '269', '258', 3, 'it is good for my cats', '2024-07-30 00:03:59');
...
(454, '2024-02-22', 'INV002', '0000-00-00', 266, 500, 494, 54, 42, NULL, 1),
(455, '2024-02-22', 'inv003', '0000-00-00', 267, 500, 400, 22.5, 42, NULL, 1),
...
(460, '2024-02-22', 'INV0001', '0000-00-00', 277, 500, 430, 90, 42, NULL, 1),
...
(466, '2024-02-22', 'INV0001', '0000-00-00', 268, 10, 6, 2, 42, NULL, 1),
...
--
ALTER TABLE `new_cart`
  MODIFY `cart_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=154;
...
--
ALTER TABLE `pos_cart`
  MODIFY `pos_cart_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1003;

--
-- AUTO_INCREMENT for table `pos_orders`
--
ALTER TABLE `pos_orders`
  MODIFY `orders_orders_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=910;
...
--
ALTER TABLE `rate_reviews`
  MODIFY `r_rate_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `users_log`
  MODIFY `act_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3781;
