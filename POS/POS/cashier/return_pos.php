...
include "controller/pos/insert_data.php";
...
<!-- newest and oldest dropdown --->
        ...
        <div class="table-responsive card">
            ...
            <table id="example" class="table table-striped" style="width:100%">
                ...
                <tbody>
                    <?php
                   $view_query = mysqli_query($connections, "SELECT * FROM returns_pos ORDER BY ret_date DESC");
...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="POST" action="controller/pos/insert_data.php" >
...
<script src='controller/pos/js/checkAll.js'></script>

<script src='controller/pos/js/returnAjax.js'></script>

<script src='controller/pos/js/divPage.js'></script>

<script src='controller/pos/js/form.js'></script>


<script src='controller/pos/js/togler.js'></script>

<script src='controller/pos/js/table.js'></script>

<script src='controller/pos/js/validation.js'></script>
