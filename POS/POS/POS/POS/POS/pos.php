...
<?php include 'navigation.php';?>
    <div class="main-screen">
        ...
        <div class="tables color-gray">
            ...
            <div class="category">
                <form action="pos.php" class="button-rounded"  method="GET" style="border: none; margin: 0px -px;">
...
function updateValues() {
    ...
    const taxPercent = parseFloat(taxValue.innerText) / 100; // Convert tax percentage to decimal
    const taxAmount = totalSum * taxPercent;
...
document.addEventListener("DOMContentLoaded", function () {
  const purchaseButton = document.querySelector(".checkout");
  ...
  purchaseButton.addEventListener("click", function () {
    // Collect and format order details here
    const items = document.querySelectorAll(".table-cart tr:not(.head-row)");
    let orderHTML = `
      <h3>Order Details:</h3>
      <table>
        <tr>
    ...
    // Get other values
    const discountValue = parseFloat(document.getElementById("discountValue").textContent.replace(/[^0-9.-]+/g,""));
    const taxValue = parseFloat(document.getElementById("taxValue").textContent.replace(/[^0-9.-]+/g,""));
    const totalValue = parseFloat(document.querySelector(".description-right b").textContent.replace(/[^0-9.-]+/g,""));

    // Add summary rows
    orderHTML += `
        <tr>
          <td colspan="3">Subtotal Sum</td>
...
const submitButton = modalContent.querySelector("#submitOrder");
...
submitButton.addEventListener("click", function () {
  ...
  // Send the data to the PHP file using Fetch API
