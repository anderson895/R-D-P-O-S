    ...
    <div class="main-screen">
        ...
        <div class="tables color-gray">
            ...
            <form action="pos.php" class="button-rounded" method="GET" style="border: none; margin: 0px -px;">
                <input required type="text" style="margin-right: -15px;" class="button-rounded search" name="query" id="searchInput" <?php if(isset($_GET['query'])) { echo 'placeholder="' . htmlspecialchars($_GET['query']) . '" value="' . htmlspecialchars($_GET['query']) . '"'; } else { echo 'placeholder="Search"'; } ?>>
            </form>
