...
FROM pos_orders
WHERE YEAR(orders_date) BETWEEN ? AND ?
...
if ($stmt = $conn->prepare($sql_query)) {
    ...
    if ($result->num_rows > 0) {
        ...
        $sheet->setCellValue('A1', 'Yearly Sales Report - Walkin');
        ...
        header('Content-Disposition: attachment;filename="yearly_sales_walkin_' . $todaydate . '.xlsx"');
