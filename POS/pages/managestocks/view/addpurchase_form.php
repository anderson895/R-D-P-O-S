...
<select class="form-select" id="supplier" onchange="getPurchasedCartData()">
    <?php
    ...
    <div class="col-lg-2 col-sm-2 col-2 ps-0">
        <div class="add-icon">
        <a href="#" data-bs-toggle="modal" data-bs-target="#ModAddStocks" id="addToCart" class="btn btn-primary toglerAddPurchase" data-spl_id="<?=$spl_id?>" style="z-index: 1050;"><img src="../../administrator/admin_view/assets/img/icons/plus1.svg" alt="img"></a>
      </div>
    </div>
</div>
</div>
...
<input class="form-control" type="text" id="referenceNo" >
</div>
</div>
...
<div class="col-lg-12 col-sm-6 col-12">
    ...
    <div class="addonset">
        <img src="../../administrator/admin_view/assets/img/icons/scanners.svg" alt="img">
    </div>
</div>
...
<div class="col-lg-12">
<button id="purchasedButton" class="btn btn-primary submitPurchased me-2">Purchased</button>
