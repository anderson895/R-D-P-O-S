        ...
        <div class="row w-100 justify-content-center">
            <div class="col-md-6 col-lg-4">
                <div class="card shadow-lg p-4">
                    <div class="text-center mb-4 p-4 shadow-sm rounded" style="background-image: url('../../upload_system/<?=$db_system_banner?>'); background-size: cover; background-position: center;">
                        <div class="overlay position-absolute top-0 start-0 w-100 h-100 bg-dark opacity-50 rounded"></div>
                        <div class="position-relative z-index-1">
                            <img src="../../upload_system/<?=$db_system_logo?>" alt="Logo" class="mb-3 img-fluid" width="80">
                            <h2 class="fw-bolder text-white"><?=$db_system_name?></h2>
                        </div>
                    </div>
