...
<section class="gradient-custom" >
  <div class="container py-2">
    ...
    <div class="row">
      ...
      <h2 class="mt-3"><i class="bi bi-chat-right-text"></i> Message</h2>
        ...
        <div class="container mt-4 " id="allMessagesContainer" style="height: 400px; overflow-y: auto;">
  ...
  <div data-mdb-input-init class="form-outline form-white">
    ...
    <div class="d-flex flex-column flex-md-row align-items-start">
      <textarea class="form-control me-2 mb-2 mb-md-0" id="sender_Messages" name="sender_Messages" rows="1" style="flex: 1;"></textarea>
