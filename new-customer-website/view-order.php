...
<div class="table-responsive">
    <table class="table">
        <thead>
            <tr>
                <td colspan="5">
                    <h5 class="font-weight-bold mt-3 mb-2 text-secondary">
        ...
        <tbody>
            ...
            ?>
                <tr style="font-size: 0.9rem;">
                    ...
                    <td class="">
                        <img src="../upload_prodImg/<?= $orderItem['prod_image'] ?>" alt="<?= $orderItem['prod_name'] ?>" style="height: 40px; width: 40px;" class="me-2">
                        <?= $orderItem['prod_name'] ?>
                    </td>
                    ...
                    <?php if ($order['status'] == 'Delivered') { ?>
                        <td class="pt-3">
                            <button class="btn btn-success rateToggler" data-bs-toggle="modal" data-bs-target="#rateTsModal" data-prod_id="<?= $orderItem['prod_id'] ?>" data-prod_name="<?= $orderItem['prod_name'] ?>">Feedback</button>
                        </td>
                    <?php } ?>
                </tr>
            <?php
            ...
            <tr>
                <td colspan="5">
                    <h5 class="font-weight-bold mt-5 mb-2 text-secondary">
                        <i class="bi bi-currency-exchange"></i> Order Details
                    </h5>
                </td>
            </tr>
            <tr>
                <td><span class="font-weight-bold">Subtotal:</span></td>
                <td colspan="2"></td>
                <td class="text-end"><span class="font-weight-bold">₱<?= number_format($order['subtotal'], 2) ?></span></td>
            </tr>
            <tr>
                <td><span class="font-weight-bold">VAT:</span></td>
                <td colspan="2"></td>
                <td class="text-end"><span class="font-weight-bold">₱<?= number_format($order['vat'], 2) ?></span></td>
            </tr>
            <tr>
                <td><span class="font-weight-bold">Shipping Fee:</span></td>
                <td colspan="2"></td>
                <td class="text-end"><span class="font-weight-bold">₱<?= number_format($order['sf'], 2) ?></span></td>
            </tr>
            <tr>
                <td><span class="text-success font-weight-bold">Total:</span></td>
                <td colspan="2"></td>
                <td class="text-end"><span class="text-success font-weight-bold">₱<?= number_format($order['total'], 2) ?></span></td>
            </tr>
            <tr>
                <td colspan="5">
                    <h5 class="font-weight-bold mt-5 mb-2 text-secondary">
    ...
    <table class="table">
        <tbody>
            <tr>
                ...
                <td colspan="2"></td>
                <td class="text-end"><span class="font-weight-bold"><?= $userAddress ?></span></td>
            </tr>
            <tr>
                <td><span class="font-weight-bold">Order Date:</span></td>
                <td colspan="2"></td>
                <td class="text-end"><span class="font-weight-bold"><?= (new DateTime($order['order_date']))->format('F j, Y, g:i a') ?></span></td>
            </tr>
            <?php if ($order['status'] == 'Delivered') { ?>
                <tr>
                    <td><span class="font-weight-bold">Delivered Date:</span></td>
                    <td colspan="2"></td>
                    <td class="text-end"><span class="font-weight-bold"><?= (new DateTime($order['delivered_date']))->format('F j, Y, g:i a') ?></span></td>
                </tr>
            <?php } ?>
            <tr>
                <td><span class="font-weight-bold">Delivery Rider:</span></td>
                <td colspan="2"></td>
                <td class="text-end"><span class="font-weight-bold"><?= $rider ?></span></td>
            </tr>
            <tr>
                <td><span class="font-weight-bold">Delivery Contact No:</span></td>
                <td colspan="2"></td>
                <td class="text-end"><span class="font-weight-bold"><?= $riderContactNo ?></span></td>
            </tr>
        </tbody>
    </table>
    ...
    <table class="table">
        <tbody>
            ...
            <tr>
                ...
                <td colspan="2"></td>
                <td class="text-end"><span class="font-weight-bold"><?= $paymentType ?></span></td>
            </tr>
            <?php if ($paymentType != 'COD') { ?>
                <tr>
                    <td colspan="4" class="text-center">
                        <h5 class="text-success mt-5"><i>Proof of Payment</i></h5>
                        <div class="pof-container">
                            <img src="backend/proof-of-payment/<?= $order['pof'] ?>" alt="Proof of Payment" class="img-fluid" style="max-width: 300px;">
                        </div>
                    </td>
                </tr>
            <?php } ?>
